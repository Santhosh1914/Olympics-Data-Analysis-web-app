...
st.sidebar.image(
    "https://www.nicepng.com/png/detail/177-1776002_olympic-logo-with-sports-summer-olympic-games.png" )
...
if user_menu == "Overall Analysis":
    ...
    fig = px.line(nations_over_time, x='count', y='Event')
    st.title("events in Olympics over Time")
    st.plotly_chart(fig)
    nations_over_time = helper.data_over_time(df, 'Name')
    fig = px.line(nations_over_time, x='count', y='Name')
    st.title("Athletes in Olympics over Time")
    st.plotly_chart(fig)
